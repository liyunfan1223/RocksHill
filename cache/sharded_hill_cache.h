//
// Created by Yunfan Li on 2024/2/25.
//
...
public:
  ...
  virtual Status Insert(
    ...
    HillHandle* e = CreateHandle(k, hash, obj, helper, charge);
  ...
  // using Cache::Release;
  bool Release(HillHandle* handle, bool useful, bool erase_if_last_ref) {
  ...
  virtual Cache::ObjectPtr Value(HillHandle* handle) {
    auto h = reinterpret_cast<const HillHandle*>(handle);
    return h->value;
  }

  virtual size_t GetCharge(HillHandle* handle) const {
  ...
  virtual const Cache::CacheItemHelper* GetCacheItemHelper(
  ...
  size_t GetOccupancyCount() const {
    // std::cout << "GetOccupancyCount Unsupporteded!";
    return 0;
  }
  ...
  size_t GetTableAddressCount() const {
    ...
    // std::cout << "GetTableAddressCount Unsupporteded!";
    return 0;
  }
